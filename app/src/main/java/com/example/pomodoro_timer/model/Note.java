...
public class Note implements Parcelable {
    ...
    public int uid; // уникальный идентификатор, имеет своё значение для каждой из сущностей

    @ColumnInfo(name = "text")
    public String text; // текст заметки

    @ColumnInfo(name = "timestamp")
    public long timestamp; // время создания заметки

    @ColumnInfo(name = "done")
    public boolean done; // дело выполнено или нет
